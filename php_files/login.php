...
<body>
    <div class="Login_container">
        <form class="form_container" method="post" action="scripts/login.php">
            ...
            <input placeholder="name@mail.com" title="Inpit title" name="input-name" type="email" class="input_field" id="email_field">
            </div>
            <div class="input_container">
            ...
            <span><a class="sign-in_ggl" href="sign_up_page.php">Create an account?</a> </span>
        </form>
    </div>
</body>
</html>